...
* The store default country, found by navigating to **Store Setup > Store Profile**, has a selected country that is one of the countries supported by the tax provider
